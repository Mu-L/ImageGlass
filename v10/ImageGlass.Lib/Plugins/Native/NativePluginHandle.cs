...
internal readonly struct NativeCodecEntry
{
    ...
    public readonly SDK.CodecPluginCapability Capability;

    public NativeCodecEntry(nint codecApiPtr, SDK.CodecPluginCapability capability)
    {
...
/// </summary>
internal sealed unsafe class NativePluginHandle : PhDisposable
{
    ...
    public NativePluginHandle(string pluginId, string libraryPath, nint libraryHandle, IGPluginApi* pluginApi)
    {
        PluginId = pluginId;
    ...
    protected override void OnDisposing()
    {
        ...
        {
            Debug.WriteLine($"[NativePluginHandle] Shutdown threw for '{PluginId}': {ex.Message}");
        }
        ...
        {
            Debug.WriteLine($"[NativePluginHandle] NativeLibrary.Free threw for '{PluginId}': {ex.Message}");
        }
