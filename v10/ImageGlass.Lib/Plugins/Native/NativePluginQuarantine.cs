...
public sealed class NativePluginQuarantine
{
    ...
    public void DisableForSession(string pluginId, string reason)
    {
        ...
        Debug.WriteLine($"[NativePluginQuarantine] Session-disabled '{pluginId}': {reason}");
    }
    ...
    public void RecordSoftFailure(string pluginId, string reason)
    {
        ...
        Debug.WriteLine($"[NativePluginQuarantine] Soft failure #{count} for '{pluginId}': {reason}");
    ...
    public void Quarantine(string pluginId, string reason)
    {
        ...
        try
        {
            ...
            Debug.WriteLine($"[NativePluginQuarantine] Quarantined '{pluginId}': {reason}");
        }
        catch (Exception ex)
        {
            Debug.WriteLine($"[NativePluginQuarantine] Failed to write marker for '{pluginId}': {ex.Message}");
        }
    }
    ...
    public bool Clear(string pluginId)
    {
        ...
        {
            Debug.WriteLine($"[NativePluginQuarantine] Failed to clear marker for '{pluginId}': {ex.Message}");
        }
        return false;
    }
