...
/// </summary>
public readonly record struct PluginRect(float X, float Y, float Width, float Height);
...
/// </summary>
public sealed class PluginPhotoMetadata
{
...
/// </summary>
public sealed class PluginPhotoListItem
{
    public string FilePath { get; init; } = string.Empty;
    public int? Width { get; init; }
    public int? Height { get; init; }
...
/// </summary>
public sealed class PluginPhotoList
{
    public PluginPhotoListItem[] Photos { get; init; } = [];
...
/// <summary>
/// Flags that control which real-time events a plugin receives.
/// </summary>
public sealed class PluginEventSubscriptions
{
...
/// </summary>
public sealed class PluginInitPayload
{
