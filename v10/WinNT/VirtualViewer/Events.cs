...
public class PanningEventArgs : EventArgs
{
    ...
    /// </summary>
    public Point HostLocation { get; private set; } = new(0, 0);

    /// <summary>
    /// Gets panning start mouse pointer location on host control
    /// </summary>
    public Point HostStartLocation { get; private set; } = new(0, 0);


    public PanningEventArgs(Point loc, Point startLoc)
    {
        HostLocation = loc;
...
public class SelectionEventArgs : EventArgs
{
    ...
    /// </summary>
    public Rect ClientSelection { get; private set; }

    /// <summary>
    /// Gets the source selection area.
    /// </summary>
    public Rect SourceSelection { get; private set; }


    public SelectionEventArgs(Rect clientSelection, Rect sourceSelection)
    {
