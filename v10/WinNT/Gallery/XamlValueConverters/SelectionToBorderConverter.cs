...
public partial class SelectionToBorderConverter : IValueConverter
{
    ...
    {
        if (value is not bool isSelected) return DefaultBorder;

        return isSelected ? SelectedBorder : DefaultBorder;
    }
